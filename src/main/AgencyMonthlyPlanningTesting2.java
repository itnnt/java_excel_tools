...
public class AgencyMonthlyPlanningTesting2 {
	...
	//test
	public synchronized static int write(XSSFWorkbook book, String sheetName, ArrayList<Row> rows ) throws IOException  {
					...
					public void run() {
						try {
							if (!f.getName().startsWith("~")) {
								...
								System.out.println(String.format("%d. Reading for: %s", c, teamName));
